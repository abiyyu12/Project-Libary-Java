...
public class AddIssued extends javax.swing.JFrame {
    ...
    private StudentsRepositories studentRepo;
    ...
    private void initComponents() {
        ...
        inputName.setToolTipText("Email");

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel5.setText("Contact");

        inputContact.setToolTipText("Alamat");
        ...
        jLabel7.setText("Note : Please Check Student ID Carefully Before Issued Books");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(inputCallNo)
                            .addComponent(inputName, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(inputContact)
                            .addComponent(inputStudentId, javax.swing.GroupLayout.Alignment.TRAILING)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        studentRepo = new StudentsRepositoriesImpl();
        boolean isAddedd = studentRepo.insertStudent(new Students(inputCallNo.getText(),
                Integer.parseInt(inputStudentId.getText().toString()),inputName.getText(),inputContact.getText()));
        if(isAddedd){
            JOptionPane.showMessageDialog(this,"Books Issue Successfully","Information Messages",JOptionPane.INFORMATION_MESSAGE);
            clean();
        }
        else{
            JOptionPane.showMessageDialog(this,"Books Issued Not Added","Error Messages",JOptionPane.ERROR_MESSAGE);
        }
