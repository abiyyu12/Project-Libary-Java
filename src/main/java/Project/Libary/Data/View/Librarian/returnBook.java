...
public class returnBook extends javax.swing.JFrame {
    ...
    private void btnReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReturnActionPerformed
        ...
        boolean isReturned = studentsRepositories.returnBooks(inputCallNo.getText(),Integer.parseInt(inputStudentID.getText()));
        if(isReturned){
            JOptionPane.showMessageDialog(this,"Books Returned","Information Message",JOptionPane.INFORMATION_MESSAGE);
            inputCallNo.setText("");
            inputStudentID.setText("");
        }
        else{
             JOptionPane.showMessageDialog(this,"Check Student ID or Books CallNo","Error Message",JOptionPane.ERROR_MESSAGE);
        }
