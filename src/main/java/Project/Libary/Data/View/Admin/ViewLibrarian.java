...
public class ViewLibrarian extends javax.swing.JFrame {
    ...
    private void refereshTable(){
        ...
        Librarian[] data = librarianRepo.getViewLibrarian();
        String[] columns ={
        ...
        for(var Temp:data){
            ...
            DataTable[i][1] = data[i].getName();
            DataTable[i][2] = data[i].getPassword();
            DataTable[i][3] = data[i].getEmail();
            DataTable[i][4] = data[i].getAddress();
            DataTable[i][5] = data[i].getCity();
            DataTable[i][6] = data[i].getContact();
            i++;
        }
